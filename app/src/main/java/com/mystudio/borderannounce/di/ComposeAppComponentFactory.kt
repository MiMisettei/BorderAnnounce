package com.mystudio.borderannounce.di
...
import com.mystudio.borderannounce.BorderAnnounceApp
...
class ComposeAppComponentFactory : AppComponentFactory() {
    ...
    override fun instantiateApplicationCompat(
        ...
        activityProviders = (app as BorderAnnounceApp).appGraph().activityProviders
        return app
    }
